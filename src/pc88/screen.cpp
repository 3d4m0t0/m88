...
{
	// 53 53 53 GR TX  80 V2 32 CL  53 53 53 L4 (b4`b6ĚzuÍĎŚČ˘ąĆ)
	...
	else
	{
		...
		case 2:										  break; //	V1 320x200 ÍíÉCOLORČĚĹB&WÍśÝľČ˘
...
void IOCALL Screen::Out53(uint, uint data)
{
	...
	else if (port33 & 0x80)
	{
		...
		port53 = data;	//	ćĘ[hŞĎXłęéÂ\ŤÉőŚClÍíÉSrbgŰś
	}
}
